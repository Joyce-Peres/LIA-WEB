...
> Para um passo a passo completo (Windows, Git, VS Code e troubleshooting), veja `GUIA-INICIANTES.md`.
...
│   └── converter_para_web.py  # Conversão para TensorFlow.js
...
## 🧠 Pipeline e arquitetura (fonte da verdade)

Para evitar duplicação e informação divergente, a documentação de pipeline/arquitetura fica em:

- `docs/prd.md` (requisitos e critérios)
- `docs/architeture.md` (decisões técnicas, pipeline e padrões)
- `docs/model-conversion.md` (conversão do modelo Keras → TF.js)
